...
// The websocket dependency is provided by the example's runtime environment.
// @ts-expect-error: socket.io-client may not be included in the app's type resolution.
